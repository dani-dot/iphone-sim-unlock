...
5. Heicard, Rsim or other such cards only work for physical sim devices (physical sim + esim or dual physical sim) and you can only use the physical sim. I have seen some esim unlock products but i havent tested them, some of them require esim to physical sim conversion
# R-SIM
...
2. Can receive sms but cant send, you need to update your sms center number:
   ...
   - if you dont have SIM Apllications or SMS Center Service Address Setting, dial in Phone " ** 5005 * 7672 * SmsCenterNumber * " or " ** 5005 * 7672 * SmsCenterNumber # " (for example " ** 5005 * 7672 * 40722006000 * " or " ** 5005 * 7672 * +40722006000 * ")(try without + first , if it doesnt work try with +) ( sometimes unpluging the sim and pluging it back helps ) 
